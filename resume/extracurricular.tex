...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Developed a terminal themed portfolio website to refresh my React skills in my own time. Integrated various APIs (i.e. compiling my resume using typesetting language LaTeX) in the app. Continuing to build and support the app over time.}
