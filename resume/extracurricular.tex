...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Maintaining a legacy application while developing a new improved solution based on asynchronous microservices, domain driven design and clean architecture practices.}
